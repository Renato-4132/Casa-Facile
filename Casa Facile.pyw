...
URL_QST = "https://forms.gle/6y6X8yePctLCY64G8"
...
class GestioneSpese(tk.Tk):
    ...
    def __init__(self):
        ...
        self.bind_all("<Right>", lambda e: (self.cicla_visualizzazione_statistiche(), "break")[1])
        self.bind_all("<Left>", lambda e: (self.cicla_indietro(), "break")[1])
