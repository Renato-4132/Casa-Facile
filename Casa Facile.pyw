    ...
    def spesa_supermercato(self):
        ...
        def _funzione_crud(azione, supermercato, treeview, frame_input):
            ...
            def _valida_lunghezza_campi_locale(refs):
                ...
                if data_scadenza:
                    formati_validi = ['%d/%m/%Y', '%d-%m-%Y'] # Presuppone GG/MM/AAAA o GG-MM-AAAA
                    data_valida = False
            ...
            if azione == 'inserisci':
                ...
                # Rimuovi il codice DateEntry
                # Il calendario popup personalizzato non ha bisogno di questa logica di set_date
