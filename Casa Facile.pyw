...
class GestioneSpese(tk.Tk):
    ...
    def __init__(self):
        ...
        ttk.Button(mode_frame, text="?", command=lambda: self.mostra_help(), width=2, style="Yellow.TButton").pack(side=tk.LEFT, padx=1)
    ...
    def mostra_help(self):
        ...
        tk.Label(
            content_frame,
            text="• **Avvio Grafico Multiplo:** Dopo aver selezionato una o più categorie (usando **CTRL/SHIFT**), clicca con il **Tasto Destro** del mouse sulle righe selezionate per avviare il grafico.\n"
        ...
        <div id="accordionContent" class="accordion-content">
            <div class="tab-content-wrapper">
                <div class="tab-container">
                    ...
                    <button class="tab-button" onclick="openTab('tabCategorie', this)">Uscite</button>
...
def check_single_instance():
    if sys.platform.startswith("win"):
        ...
        if os.path.exists(lock_file_path):
            try:
                os.remove(lock_file_path)
                print(f"File lock orfano rimosso: {lock_file_path}")
            except Exception as e:
                print(f"Avviso: Impossibile rimuovere il file lock orfano: {e}")
                pass
        try:
